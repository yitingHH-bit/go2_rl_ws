...
class Go2_RL_Nav_Actions(Node):
    def __init__(self):
        ...
        model_path = os.path.join(share_dir, 'models', 'policy_6000_tough1.onnx')
    ...
    def scan_callback(self, msg):
        ...
        # 训练端实际是 (N,360)，部署端单帧 -> (1,360)  real input is (N, 360)   
        #self.model_in = data.reshape(1, 360)  #earlier version
        self.model_in = torch.from_numpy(data).unsqueeze(0) 
            # ====== 安全保护机制 ======
    ...
    def generate_actions(self):
        ...
        obs = np.concatenate((self.base_ang_vel,
